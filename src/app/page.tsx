  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-2">{t('home.title')}</h1>
      ...
      <div className="grid grid-cols-3 gap-4 w-full max-w-md">
        ...
        >
          <Guitar size={24} />
          <span className="text-sm font-medium">{t('home.instruments')}</span>
        </Link>
        ...
        >
          ...
          <span className="text-sm font-medium">{t('home.status')}</span>
        </Link>
        ...
        >
          ...
          <span className="text-sm font-medium">{t('home.measures')}</span>
        </Link>
      </div>
    </div>
  );
